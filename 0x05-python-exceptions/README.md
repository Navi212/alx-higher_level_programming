...
Write a function that executes a function safely.
    ...
    Otherwise, returns None if something happens during the function and prints in 
...
Create three C functions that print some basic info about Python lists, Python bytes 
...
About:
    ...
    -Wextra -pedantic -std=c99 -shared -Wl,-soname,libPython.so -o libPython.so -fPIC 
...
NOTE:
    ...
    It is strongly advised to either use setbuf(stdout, NULL); or fflush(stdout) in your 
    C functions IF you choose to use printf. The reason to that is that Pythonsprintand 
